    ...
    mainPanel(
      tabsetPanel(
        tabPanel("Lap Times",
                 ...
                 tags$em("This plot is a comaprison for laptimes between Lewis Hamilton(in blue) and Max Verstappen(in red) 
                 for Abu Dhabi Grand Prix 2021.")
        ),
        tabPanel("Telemetry Data",
                 plotOutput("telemetry_table"),
                 tags$em("This plot is a comaprison of various telemetries between Lewis Hamilton(in blue) and Max Verstappen(in red) 
